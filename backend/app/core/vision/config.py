...
class VisionConfig:
    ...
    # ------------------------------------------------------------------
    smart_frame_selection_enabled: bool = False
    use_multimodal: bool = False
    multimodal_model: str = "Qwen/Qwen2-VL-7B-Instruct"  # or "google/gemma-3-4b-it"
    multimodal_device: str = "auto"  # "cuda", "cpu", "auto"
    multimodal_timeout_seconds: float = 30.0
    multimodal_max_new_tokens: int = 512
