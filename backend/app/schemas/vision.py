...
class VisionResultSchema(BaseModel):
    ...
    # Keys are string representations of float timestamps (e.g. "2.0")
    # Values are relative API URL paths for serving the JPEG thumbnail
    frame_thumbnails: Optional[Dict[str, str]] = None
