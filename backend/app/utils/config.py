...
Lee las variables de entorno desde un archivo .env y expone
un objeto 'settings' con todos los parámetros del sistema.

Secciones de configuración:
- Base de datos y Redis
- Almacenamiento S3 (MinIO)
- Autenticación JWT
- Pipeline de visión (frames, modelos, flags)
- Pipeline de audio (sample rate, Whisper, diarización)
- Fusión multimodal (OpenAI, Ollama)
...
@lru_cache()
def get_settings():
    """Retorna la instancia única (singleton) de Settings."""
    return Settings()
